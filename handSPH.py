...
class GraspDeformableBlock(Application):
    ...
    def create_particles(self):
        # 1) deformable block (lower stiffness)
        ...
        # helper to build stiff, heavy solids:
        ...
        # 2) platform & jaws: super-stiff, super-heavy
        #    E=1e10 Pa, mass_factor=1e5 → effectively rigid
        E_rigid = 1e10
        MF = 1e5
    ...
    def create_scheme(self):
        # include *all four* as elastic_solids
    ...
    def post_step(self, solver):
        # open/close jaws by assigning their velocity,
        # which the integrator now *will* pick up
        ...
        # these velocities now get integrated by PySPH
        for gr in (g1, g2):
            gr.x  += gr.u * dt
            gr.y  += gr.v * dt
            gr.z  += gr.w * dt
