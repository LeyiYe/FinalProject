...
class GraspDeformableBlock(Application):
    ...
    def create_particles(self):
        # --- deformable block using built-in helper ---
        ...
        # --- rigid platform & grippers (minimal props) ---
    ...
    def create_equations(self):
        ...
        # add gravity on the block
        eqns.append(Group(
            equations=[BodyForce(dest='block', sources=None,
                                 fx=0, fy=0, fz=-9.81)],
            real=False
        ))
        return eqns
    ...
    def post_step(self, solver):
        # simple open/close logic for grippers
