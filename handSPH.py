...
class ViscousDamping(Equation):
    ...
    def loop(self, d_idx, d_u, d_v, d_w, d_au, d_av, d_aw):
        # simple damping proportional to velocity
...
class GraspDeformableBlock(Application):
    def initialize(self):
        ...
        # Enable gravity to let block settle
    ...
    def create_particles(self):
        ...
        # Add properties for DEM collision
        ...
        # 2) Rigid bodies: platform and two grippers
    ...
    def create_scheme(self):
        ...
        # Only the block is elastic; walls are passive for collision
    ...
    def create_equations(self):
        ...
        eqns.append(Group(
            equations=[
                RigidBodyWallCollision('block', ['platform'], kn=1e5, mu=0.5, en=0.0),  # stiffer wall to prevent penetration
        ...
        # (4) convert collision forces → accelerations
        eqns.append(Group(
            equations=[
