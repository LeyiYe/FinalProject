...
class GraspDeformableBlock(Application):
    ...
    def create_particles(self):
        ...
        # 2) Platform & grippers as rigid solids
    ...
    def create_scheme(self):
        # block is elastic; platform & grippers are rigid solids
    ...
    def post_step(self, solver):
        ...
        if g1.x[0] < target:
            ...
            # lift
            g1.u[:] = g2.u[:] = 0.0
            g1.w[:] = g2.w[:] = 0.3  # 30 cm/s

        # **no direct x/y/z updates**—the integrator moves rigid bodies
        # once per step based on u,v,w.
